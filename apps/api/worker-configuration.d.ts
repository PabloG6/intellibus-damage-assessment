/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17f815aaa8966155227d6f0d5f05a8ab)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PARTYKIT_SERVICE_SECRET: "yardwatch-local-service-secret";
		REALTIME_TOKEN_SECRET: "yardwatch-local-realtime-secret";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ALLOWED_ORIGINS" | "PARTYKIT_URL" | "PARTYKIT_SERVICE_SECRET" | "REALTIME_TOKEN_SECRET" | "GOOGLE_MAPS_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
