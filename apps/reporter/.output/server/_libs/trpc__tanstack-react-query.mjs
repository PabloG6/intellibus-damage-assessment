...
import { T as TRPCUntypedClient, g as getUntypedClient } from "./trpc__client.mjs";
import { c as createRecursiveProxy, r as run, i as isObject, d as isFunction, e as isAsyncIterable, f as callProcedure } from "./trpc__server.mjs";
import { b as skipToken } from "./tanstack__query-core.mjs";
import { i as infiniteQueryOptions, q as queryOptions } from "./tanstack__react-query.mjs";
...
var require_objectWithoutPropertiesLoose = __commonJS({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/objectWithoutPropertiesLoose.js"(exports$1, module) {
...
var require_objectWithoutProperties = __commonJS({ "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/objectWithoutProperties.js"(exports$1, module) {
...
function createTRPCContext() {
  const TRPCClientContext = reactExports.createContext(null);
  const TRPCContext = reactExports.createContext(null);
  const TRPCProvider = (props) => {
    const value = reactExports.useMemo(() => createTRPCOptionsProxy({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(TRPCClientContext.Provider, {
      value: props.trpcClient,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(TRPCContext.Provider, {
        value,
  ...
  function useTRPC() {
    const utils = reactExports.useContext(TRPCContext);
    if (!utils) throw new Error("useTRPC() can only be used inside of a <TRPCProvider>");
    return utils;
  }
  function useTRPCClient() {
    const client = reactExports.useContext(TRPCClientContext);
